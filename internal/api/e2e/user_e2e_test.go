...
func TestCreateUser(t *testing.T) {
	...
	t.Run("should not be able to create a user with empty name", func(t *testing.T) {
		...
		var dst kind.Response
		json.NewDecoder(response.Body).Decode(&dst)

		if dst["message"] != user.ERR_FULLNAME_EMPTY {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_FULLNAME_EMPTY, dst["message"])
		}
	...
	t.Run("should not be able to create a user if name length less than 10 characters", func(t *testing.T) {
		...
		if dst["message"] != user.ERR_FULLNAME_INVALID {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_FULLNAME_INVALID, dst["message"])
		}
	...
	t.Run("should not be able to create a user with empty email", func(t *testing.T) {
		...
		if dst["message"] != user.ERR_EMAIL_EMPTY {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_EMAIL_EMPTY, dst["message"])
		}
	...
	t.Run("should not be able to create a user if the email is invalid", func(t *testing.T) {
		...
		if dst["message"] != user.ERR_EMAIL_INVALID {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_EMAIL_INVALID, dst["message"])
		}
	...
	t.Run("should not be able to create a user with empty creci_id", func(t *testing.T) {
		...
		if dst["message"] != user.ERR_CRECIID_EMPTY {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_CRECIID_EMPTY, dst["message"])
		}
	...
	t.Run("should not be able to create a user if creci_id is invalid", func(t *testing.T) {
		...
		if dst["message"] != user.ERR_CRECIID_INVALID {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_CRECIID_INVALID, dst["message"])
		}
	...
	t.Run("should not be able to create a user with empty cellphone", func(t *testing.T) {
		...
		if dst["message"] != user.ERR_CELLPHONE_EMPTY {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_CELLPHONE_EMPTY, dst["message"])
		}
	...
	t.Run("should not be able to create a user if cellphone is invalid", func(t *testing.T) {
		...
		if dst["message"] != user.ERR_CELLPHONE_INVALID {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_CELLPHONE_INVALID, dst["message"])
		}
	...
	t.Run("should not be able to create a user with empty password", func(t *testing.T) {
		...
		if dst["message"] != user.ERR_PASSWORD_EMPTY {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_PASSWORD_EMPTY, dst["message"])
		}
	...
	t.Run("should not be able to create a user if password is invalid", func(t *testing.T) {
		...
		if dst["message"] != user.ERR_PASSWORD_INVALID {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_PASSWORD_INVALID, dst["message"])
		}
...
func TestFindByUser(t *testing.T) {
	...
	t.Run("should not be able to find a user by providing both ID and email together", func(t *testing.T) {
		...
		if dst["message"] != user.ERR_ONLY_ONE_MUST_PARAMETER_MUST_BE_PROVIDED {
			t.Errorf("expected error: %s\ngot: %s", user.ERR_ONLY_ONE_MUST_PARAMETER_MUST_BE_PROVIDED, dst["message"])
		}
