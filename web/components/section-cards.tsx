    ...
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2">
      <Card className="@container/card">
        <CardHeader>
          ...
          <CardTitle className="text-xl xs:text-2xl font-semibold tabular-nums">
            R$60.560,00
          </CardTitle>
          <CardAction>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">
            Leve aumento este mês <IconTrendingUp className="size-4" />
          </div>
          <div className="text-muted-foreground">
            Mês anterior: R$60.340,00
          </div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Novos locatários</CardDescription>
          <CardTitle className="text-xl xs:text-2xl font-semibold tabular-nums">
            +2
          </CardTitle>
          <CardAction>
